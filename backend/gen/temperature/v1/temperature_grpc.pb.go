...
const (
	TemperatureService_CelsiusToKelvin_FullMethodName = "/temperature.v1.TemperatureService/CelsiusToKelvin"
)
...
type TemperatureServiceClient interface {
	CelsiusToKelvin(ctx context.Context, in *CelsiusToKelvinRequest, opts ...grpc.CallOption) (*CelsiusToKelvinResponse, error)
}
...
func (c *temperatureServiceClient) CelsiusToKelvin(ctx context.Context, in *CelsiusToKelvinRequest, opts ...grpc.CallOption) (*CelsiusToKelvinResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CelsiusToKelvinResponse)
...
type TemperatureServiceServer interface {
	CelsiusToKelvin(context.Context, *CelsiusToKelvinRequest) (*CelsiusToKelvinResponse, error)
...
func (UnimplementedTemperatureServiceServer) CelsiusToKelvin(context.Context, *CelsiusToKelvinRequest) (*CelsiusToKelvinResponse, error) {
...
func _TemperatureService_CelsiusToKelvin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemperatureServiceServer).CelsiusToKelvin(ctx, req.(*CelsiusToKelvinRequest))
	}
...
var TemperatureService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "temperature.v1.TemperatureService",
